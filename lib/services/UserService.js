    ...
    async registration () {
        ...
        try {
            ...
            const result = await executeQuery({
                sqlConnection,  
                query: 'INSERT INTO users (name, last_name, account, hash_password, verification_token, verification_token_expire, provider) VALUES ($1, $2, $3, $4, $5, $6, $7)',
            ...
            console.log('clear first',cleanFirstName)
            console.log('cleanlast', cleanLastName)
