    ...
    async updateClearance() {
        ...
        try {
            ...
            if (result.rowCount > 0) {
                ...
                return { error: 'Nepodařilo se aktualizovat oprávnění', status: 500 };
            }
        } catch (error) {
    ...
    async updateLocked() {
        ...
        try {
            ...
            if (result.rowCount > 0) {
                ...
                return { error: 'Nepodařilo se aktualizovat blokaci', status: 500 };
            }
        } catch (error) {
    ...
    async deleteAccount() {
        ...
        try {
            ...
            if (result.rowCount > 0) {
                ...
                return { error: 'Nepodařilo se smazat účet', status: 500 };
            }
        } catch (error) {
