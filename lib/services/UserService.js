    ...
    async registration () {
        ...
        try {
            ...
            const result = await executeQuery({
                sqlConnection,  
                query: 'INSERT INTO users (name, last_name, account, hash_password, verification_token, verification_token_expire, provider, ban_time_stamp) VALUES ($1, $2, $3, $4, $5, $6, $7, $8);',
                values: [cleanFirstName, cleanLastName, cleanUser, hashedPassword, verification_token, verification_token_expire, provider, banStamp],
            });
